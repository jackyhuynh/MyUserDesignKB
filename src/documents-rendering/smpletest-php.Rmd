...
SimpleTest (Unit Testing for PHP) is a regression testing framework that built around test cases

## SimpleTest Pre-requirement

- Understand of Unit Testing 
- Understand of PHP Web development language
- Know how to program (Design for developer)

## SimpleTest Features

- Easy to use and extend
- Automation testing (schedule scripts)
- Designed to Complete PHP developer test solution (test case, test suite, automation)
...
- Use as PHP script, develop along with source code
- Use Simple Test to develop test case and test suite (*)
- _**Retrieved from (1)**_
...
<?php
// required library
// The "autorun.php" runs our test for us.
...
class FileTestCase extends UnitTestCase {
    ...
    // check that a file has been created by the Writer object
...
- Pre condition:
  ...
  - Temporary change in the behavior of these external services can cause immediate failures within your test suite. (3)
- Using Mock Objects:
  - We test our app in a controlled environment
  - Replacing actual request with a mock object (simulated object)
  - Successfully simulate external services outage and design a response (predicted way)
...
- Technology
  ...
  - Simple Test
- Scenario:
  - Test database connection, simulate database being down without create broken database for real
...
Create mock version of DatabaseConnection:
  - include the mock object library
  - run the generator
```php
<?php
...
## Python Mock Object:
Using Python Mock Object of unit test package
```bash
